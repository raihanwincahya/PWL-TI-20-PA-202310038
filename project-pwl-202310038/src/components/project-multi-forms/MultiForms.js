...
const FormMulti = () => {
    ...
    const RowItem = ({ data, index }) => {
        return (
            <tr>
                ...
                {index !== 0 ? (
                    <td>
                        <button className="btn btn-danger" type='button' onClick={(e) => setPostData((prev) => {
                            const newData = [...prev]
    ...
    return (
        <div id='form-multiple' className='card container p-0 mt-5'>
            ...
            <div className="card-body p-0">
                <form method="post" autoComplete='off' onSubmit={(e) => handlerSubmit(e)}>
                    <table className="table table-flush align-middle table-row-bordered table-row-solid gy-4 gs-9">
                        <thead className='fs-6 fw-bold bg-light'>
                            <tr>
                                <th>NPM</th>
                                <th>First Name</th>
                                <th>Middle Name</th>
                        ...
                        <tfoot>
                            <tr>
                                <td colSpan={5}>
                                    <button className="btn btn-primary" type='button' onClick={() => setPostData(prev => {
                                        return [...prev, objProfile]
                                    })}>
                                        <IoAddCircleOutline size={24} /> Add new row
                                    </button>
                                </td>
                            </tr>
                        </tfoot>
